...
import { ClipboardCheck, FlaskConical, LogOut, Menu, Network, ScrollText, ShieldCheck, SprayCan, TableProperties, X } from 'lucide-vue-next'
...
const nav = computed(() => [
  ...
  { to: '/mitigations', label: '缓解复核', icon: SprayCan, show: true },
